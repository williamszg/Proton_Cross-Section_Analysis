...
// Thu May 18 15:00:54 2017 by ROOT version 6.08/06
// from TTree anatree/analysis tree
// found on file: /lariat/data/users/jasaadi/DataDriven_MonteCarloSamples_AnaTreeFiles/ProtonRunI_DDMC_AnaTree.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[18];   //[nclus]
   Double_t        clusterttick[18];   //[nclus]
   Double_t        cluendwire[18];   //[nclus]
   Double_t        cluendtick[18];   //[nclus]
   Int_t           cluplane[18];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[7];   //[ntracks_reco]
   Double_t        trkvtxy[7];   //[ntracks_reco]
   Double_t        trkvtxz[7];   //[ntracks_reco]
   Double_t        trkendx[7];   //[ntracks_reco]
   Double_t        trkendy[7];   //[ntracks_reco]
   Double_t        trkendz[7];   //[ntracks_reco]
   Double_t        trkstartdcosx[7];   //[ntracks_reco]
   Double_t        trkstartdcosy[7];   //[ntracks_reco]
   Double_t        trkstartdcosz[7];   //[ntracks_reco]
   Double_t        trkenddcosx[7];   //[ntracks_reco]
   Double_t        trkenddcosy[7];   //[ntracks_reco]
   Double_t        trkenddcosz[7];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[7];   //[ntracks_reco]
   Double_t        trklength[7];   //[ntracks_reco]
   Double_t        trkmomrange[7];   //[ntracks_reco]
   Double_t        trkmommschi2[7];   //[ntracks_reco]
   Double_t        trkmommsllhd[7];   //[ntracks_reco]
   Int_t           ntrkhits[7];   //[ntracks_reco]
   Double_t        trkx[7][1000];   //[ntracks_reco]
   Double_t        trky[7][1000];   //[ntracks_reco]
   Double_t        trkz[7][1000];   //[ntracks_reco]
   Double_t        trkpitch[7][2];   //[ntracks_reco]
   Int_t           trkhits[7][2];   //[ntracks_reco]
   Double_t        trkdedx[7][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[7][2][1000];   //[ntracks_reco]
   Double_t        trkrr[7][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[7][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[7][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[7][2];   //[ntracks_reco]
   Double_t        trkpida[7][2];   //[ntracks_reco]
   Int_t           nTrajPoint[7];   //[ntracks_reco]
   Double_t        pHat0_X[7][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[7][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[7][1000];   //[ntracks_reco]
   Double_t        trjPt_X[7][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[7][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[7][1000];   //[ntracks_reco]
   Int_t           trkg4id[7];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[491];   //[nhits]
   Int_t           hit_wire[491];   //[nhits]
   Int_t           hit_channel[491];   //[nhits]
   Double_t        hit_peakT[491];   //[nhits]
   Double_t        hit_charge[491];   //[nhits]
   Double_t        hit_ph[491];   //[nhits]
   Double_t        hit_tstart[491];   //[nhits]
   Double_t        hit_tend[491];   //[nhits]
   Int_t           hit_trkid[491];   //[nhits]
   Int_t           hit_trkkey[491];   //[nhits]
   Int_t           hit_clukey[491];   //[nhits]
   Int_t           hit_pk[491];   //[nhits]
   Int_t           hit_t[491];   //[nhits]
   Int_t           hit_ch[491];   //[nhits]
   Int_t           hit_fwhh[491];   //[nhits]
   Double_t        hit_rms[491];   //[nhits]
   Double_t        hit_nelec[491];   //[nhits]
   Double_t        hit_energy[491];   //[nhits]
   Float_t         hit_dQds[491];   //[nhits]
   Float_t         hit_dEds[491];   //[nhits]
   Float_t         hit_ds[491];   //[nhits]
   Float_t         hit_resrange[491];   //[nhits]
   Float_t         hit_x[491];   //[nhits]
   Float_t         hit_y[491];   //[nhits]
   Float_t         hit_z[491];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[2426];   //[maxTrackIDE]
   Double_t        IDEPos[2426][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[146];   //[geant_list_size]
   Double_t        Eng[146];   //[geant_list_size]
   Double_t        Px[146];   //[geant_list_size]
   Double_t        Py[146];   //[geant_list_size]
   Double_t        Pz[146];   //[geant_list_size]
   Double_t        EndEng[146];   //[geant_list_size]
   Double_t        EndPx[146];   //[geant_list_size]
   Double_t        EndPy[146];   //[geant_list_size]
   Double_t        EndPz[146];   //[geant_list_size]
   Double_t        StartPointx[146];   //[geant_list_size]
   Double_t        StartPointy[146];   //[geant_list_size]
   Double_t        StartPointz[146];   //[geant_list_size]
   Double_t        EndPointx[146];   //[geant_list_size]
   Double_t        EndPointy[146];   //[geant_list_size]
   Double_t        EndPointz[146];   //[geant_list_size]
   Int_t           Process[146];   //[geant_list_size]
   Int_t           NumberDaughters[146];   //[geant_list_size]
   Int_t           Mother[146];   //[geant_list_size]
   Int_t           TrackId[146];   //[geant_list_size]
   Int_t           process_primary[146];   //[geant_list_size]
